...
const Icons = memo(function Icons() {
  const resources: IResource[] = [
    { key: 'github', link: 'https://github.com/explooosion', img: FaSquareGithub },
    { key: 'gitlab', link: 'https://gitlab.com/explooosion', img: FaSquareGitlab },
    { key: 'blog', link: 'https://dotblogs.com.tw/explooosion', img: FaSquareRss },
  ...
  return (
    <div className="flex items-center justify-between w-4/5 max-w-[250px]">
      {resources.map(
        resource => <Icon key={resource.key} resource={resource} />
      )}
    </div>
  );
});
